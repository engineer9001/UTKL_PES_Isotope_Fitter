...
def parse_arguments():
    ...
    fit_args.add_argument("--use_columns", type=parse_comma_separated_list, default=[2,3,4,7,8,9],
                          help="Columns of the data file to be used (generally don't change unless file is modified)")

    fit_args.add_argument("--column_names", type=parse_comma_separated_list, default=["TimeL", "ChargeL", "ChannelIDL", "TimeR", "ChargeR", "ChannelIDR"],
                          help="Titles of the column names of the data file - must match length of use_columns argument")
